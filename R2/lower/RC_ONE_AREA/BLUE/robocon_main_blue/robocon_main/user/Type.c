...
POS_TRACKER NAV_LOCK_POS_PID ={
	.pid_x = {.fpKp = 1.6f, .fpKi = 0.00f, .fpKd = 0.0f, .fpUMax = 2500.f, .fpUpMax = 1200.f, .fpUdMax = 3000.f, .fpSumEMax = 400.f, .fpEMax = 500.f, .fpEMin = 3.0f},
	.pid_y = {.fpKp = 1.6f, .fpKi = 0.00f, .fpKd = 0.0f, .fpUMax = 2500.f, .fpUpMax = 1200.f, .fpUdMax = 3000.f, .fpSumEMax = 400.f, .fpEMax = 500.f, .fpEMin = 3.0f},
